    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          // Content
          const SafeArea(child: OfficeManagementPanel()),
        ],
      ),
    );
  }
...
class OfficeManagementPanel extends ConsumerWidget {
  final double bottomPadding;
  final bool showHeader;

  const OfficeManagementPanel({
    super.key,
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                userAgentAsync.when(
                  data: (agent) => Text(
                    "Balance: \$${agent?.balance.toStringAsFixed(0) ?? '0'}",
