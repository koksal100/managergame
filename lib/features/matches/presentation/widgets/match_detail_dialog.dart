...
class MatchDetailDialog extends ConsumerWidget {
            ...
            if (match.isPlayed)
              Padding(
                ...
                child: statsAsync.when(
                  data: (stats) {
                    final homeEvents = _reconstructMatchEvents(
                      stats,
                      match.homeClubId,
                    );
                    final awayEvents = _reconstructMatchEvents(
                      stats,
                      match.awayClubId,
                    );
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: homeEvents
                                .map((e) => _buildEventItem(e, TextAlign.left))
                                .toList(),
                          ),
                        ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: awayEvents
                                .map((e) => _buildEventItem(e, TextAlign.right))
                                .toList(),
                          ),
                        ),
                      ],
  ...
  List<_MatchEvent> _reconstructMatchEvents(
    List<MatchDetailStat> stats,
    int clubId,
  ) {
