...
final fixtureProvider = FutureProvider.family<List<FixtureItem>, FixtureParams>(
  (ref, params) async {
    ...
    final matches = await matchRepo.getMatchesByLeagueAndWeek(
      params.leagueId,
      1,
      params.week,
    );
    ...
    return clubsResult.fold((failure) => [], (clubs) {
