...
class _HomePageState extends ConsumerState<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return initialization.when(
      data: (_) => Scaffold(
        extendBody:
            true, // Arka planın navigasyon barın altına uzanmasını sağlar
        body: Stack(
          children: [
            // 1. Sayfa İçeriği
                ...
                children: [
                  ...
                  if (_currentIndex == 0) ...[
                    ...
                    const Padding(
                      ...
                      child: GlassContainer(height: 30, child: _TickerWidget()),
                    ),
                  ],
            ...
            gradient: LinearGradient(
              ...
              colors: [
                ...
                Colors.black.withOpacity(
                  0.8,
                ), // Alt kısım nav bar için daha koyu
              ],
            ),
          ),
        ),
...
class _TickerWidgetState extends ConsumerState<_TickerWidget>
    with SingleTickerProviderStateMixin {
          ...
          builder: (context, child) {
            return LayoutBuilder(
              builder: (context, constraints) {
                ...
                final offset =
                    screenWidth - (totalDistance * _controller.value);
